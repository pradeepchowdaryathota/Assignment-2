...
# Create a list containing the number of times each nucleotide (A,C,G,T,a,c,g,t) is contained in the first 1000 base pairs.
...
###Q4(b)
# create a empty list to store the counts of each kilobase
all_kilobase_counts = []
